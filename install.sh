...
function forceStuffs {
  curl -O https://cdn.discordapp.com/attachments/957608827715473470/1076781198015217745/server-icon.png

  curl -o plugins/Hibernate.jar https://dev.bukkit.org/projects/hibernate/files/latest

  echo "motd=Powered by KnighHost.live | Change this motd in server.properties" >> server.properties
}
...
case $n in
  ...
  8)
    ...
    curl -O https://api.papermc.io/v2/projects/paper/versions/1.19.3/builds/404/downloads/paper-1.19.3-404.jar
